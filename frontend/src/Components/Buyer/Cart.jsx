...
const Cart = () => {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-around",width: "100%", border: "2px solid black", }}>
      <div  style={{
          width: "60%",}}>
      {cartProducts.map((cartpro) => (
        <div   style={{
          ...
          <div>
            <img style={{ width: "100%", height: "250px" }} src={cartpro.image} />
          </div>
      ...
      <div
          style={{ width: "25%", height: "300px", border: "1px solid black", marginTop:"20px" }}
        >
